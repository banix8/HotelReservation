...
private  Image Backgroundimage;
      	   ...
      	   JLabel hLogo, tagLine, RPreview, RBooking, lblx;//lblN1,lblN2,lblR; 
      	   ...
      	   String imgLink = "D:/Documents/School/3rd Year/2nd Semester/OOP/HotelReservation/HotelReservation/img/";
           Icon logo = new ImageIcon(imgLink + "logo.png");
      	   Icon PPreview = new ImageIcon(imgLink + "Room1.jpg");
      	   Icon Rm01 = new ImageIcon(imgLink + "Room2.jpg");
      	   Icon Rm02 = new ImageIcon(imgLink + "Room1.jpg");
      	   Icon Rm03 = new ImageIcon(imgLink + "Room3.jpg");
      	   Icon Rm04 = new ImageIcon(imgLink + "Room4.jpg");
      	   Icon Rm05 = new ImageIcon(imgLink + "Room5.jpg");
      	   Icon Rm06 = new ImageIcon(imgLink + "Room6.jpg");
      	   Icon Rm07 = new ImageIcon(imgLink + "Room7.jpg");
      	   Icon Rm08 = new ImageIcon(imgLink + "Room8.jpg");
      	   Icon Rm09 = new ImageIcon(imgLink + "Room9.jpg");
      	   Icon Rm010 = new ImageIcon(imgLink + "Room10.jpg");
      	   Icon Rm011 = new ImageIcon(imgLink + "Room11.jpg");
      	   Icon Rm012 = new ImageIcon(imgLink + "Room12.jpg");
      	   Icon Rm013 = new ImageIcon(imgLink + "Room13.jpg");
      	   Icon Rm014 = new ImageIcon(imgLink + "Room14.jpg");
      	   Icon Rm015 = new ImageIcon(imgLink + "Room15.jpg");
      	   Icon Rm016 = new ImageIcon(imgLink + "Room16.jpg");
      	   Icon Rm017 = new ImageIcon(imgLink + "Room17.jpg");
      	   Icon Rm018 = new ImageIcon(imgLink + "Room18.jpg");
      	   Icon Rm019 = new ImageIcon(imgLink + "Room19.jpg");
      	   Icon Rm020 = new ImageIcon(imgLink + "Room20.jpg");
      	 ...
      	 public roomReservation() {
      	 	...
      	 	Cf.setBackground(new Color(10,0,10));
            ...
            hLogo = new JLabel(logo);
      	 	...
      	 	//Details
      	 	RDetails = new JTextArea("Room Amenities\n* Air Condition with 42 Cable TV\n* Unlimited Wifi\n* Comfortable Bed\n*Bathroom and sink");
      	...
      	/* 	lblN1 = new JLabel("NUMBER 1");
      	 	...
      	 	tagLine.setFont(new Font("Serif", Font.PLAIN, 18));
      	 	tagLine.setForeground(Color.white);
      	 	
      	 	add(RPreview);
      	 	RPreview.setBounds(10,80,640,300);
      	 	
      	 	add(RDetails);
      	 	RDetails.setBounds(10,380,640,100);
      	 	RDetails.setBackground(Color.white);
      	 	RDetails.setFont(new Font("Serif", Font.PLAIN, 18));
      	 	RDetails.setForeground(Color.black);
